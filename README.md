...
To publish a new version of the pre-commit hooks, simply create a tag and name it the same as the new version e.g. v1.0.0. Afterwards just update the version in your `.pre-commit-config.yaml` files.
